...
conclude with an R demo (Section~\ref{sec-R-demo-misspecification}).
...
to outliers; see Section Section~\ref{sec-robust-estimation}.
...
\section{The permutation test}\label{sec-permutation-test}}
...
\hypertarget{ch-glm-theory}{%
\chapter{Generalized linear models: General
theory}\label{ch-glm-theory}}
...
(Section Section~\ref{sec-edm}), a generalization of the Gaussian
...
as special cases (Section Section~\ref{sec-glm-def}). Next, we discuss
maximum likelihood inference in GLMs (Section
Section~\ref{sec-glm-max-lik}). Finally, we discuss how to carry out
statistical inference in GLMs (Section Section~\ref{sec-glm-inf}).

\hypertarget{sec-edm}{%
\section{Exponential dispersion model (EDM)
...
{\centering \includegraphics{glm-general-theory_files/figure-pdf/unnamed-chunk-15-1.pdf}
...
\hypertarget{sec-glms-special-cases}{%
\chapter{Generalized linear models: Special
cases}\label{sec-glms-special-cases}}
...
{\centering \includegraphics{glm-special-cases_files/figure-pdf/unnamed-chunk-6-1.pdf}
...
{\centering \includegraphics{glm-special-cases_files/figure-pdf/unnamed-chunk-8-1.pdf}
