...
Storey et al. (2004) showed that the Storey-BH procedure controls FDR at level $q$ under independent $p$-values.

::: {#prp-storey-bh}

The Storey-BH procedure controls FDR at level $q$ under independent $p$-values.
