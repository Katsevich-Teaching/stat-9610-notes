...
\item
  \textbf{Chapter 6. Multiple testing.} How to adjust for multiple
  hypothesis testing, both in the context of GLMs and more generally.
\end{itemize}
...
In this unit, we will focus on estimating the coefficients
\(\boldsymbol{\beta}\) and variance \(\sigma^2\) of a linear regression
model. We will interpret these estimates from geometric, algebraic, and
...
\section{\texorpdfstring{The \(C\)-groups
...
\subsection{\texorpdfstring{ANOVA decomposition for \(C\) groups
...
\subsection{ANOVA decomposition for simple linear
...
\subsection{\texorpdfstring{Connection between \(R^2\) and
...
{\centering \includegraphics{r-demo-part-2_files/figure-pdf/unnamed-chunk-3-2.pdf}
...
{\centering \includegraphics{r-demo-part-2_files/figure-pdf/unnamed-chunk-3-3.pdf}
...
# A tibble: 4 x 4
  ...
  <chr>                <dbl>       <dbl>              <dbl>
1 (Intercept)       1.16        1.48               1.38    
2 educ              0.00489     0.00705            0.00640 
3 exper             0.000232    0.000252           0.000242
4 metro             0.186       0.120              0.121   
\end{verbatim}
...
\begin{verbatim}
      (Intercept)     educ     exper     metro
2.5%   -12.321867 1.075399 0.1026900 0.8236641
97.5%   -7.533149 1.397388 0.1665347 2.1785376
\end{verbatim}
...
\begin{verbatim}
                    1           2          3          4          5
(Intercept) -8.758145 -10.2146338 -9.7471101 -11.874538 -9.8246967
educ         1.188527   1.2484078  1.1799435   1.380790  1.2090060
exper        0.104212   0.1448643  0.1462231   0.136487  0.1578132
metro        1.438395   1.5319595  1.9275520   1.461121  0.9129863
\end{verbatim}
...
{\centering \includegraphics{r-demo-part-2_files/figure-pdf/unnamed-chunk-11-1.pdf}
...
{\centering \includegraphics{r-demo-part-2_files/figure-pdf/unnamed-chunk-14-1.pdf}
...
{\centering \includegraphics{r-demo-part-2_files/figure-pdf/unnamed-chunk-15-1.pdf}
...
{\centering \includegraphics{r-demo-part-2_files/figure-pdf/unnamed-chunk-25-1.pdf}
...
{\centering \includegraphics{r-demo-part-2_files/figure-pdf/unnamed-chunk-25-2.pdf}
...
{\centering \includegraphics{r-demo-part-2_files/figure-pdf/unnamed-chunk-25-3.pdf}
...
{\centering \includegraphics{r-demo-part-2_files/figure-pdf/unnamed-chunk-30-1.pdf}
...
{\centering \includegraphics{r-demo-part-2_files/figure-pdf/unnamed-chunk-31-1.pdf}
...
{\centering \includegraphics{r-demo-part-2_files/figure-pdf/unnamed-chunk-31-2.pdf}
...
{\centering \includegraphics{r-demo-part-2_files/figure-pdf/unnamed-chunk-31-3.pdf}
